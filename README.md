...
|___>     For each ![xi](https://latex.codecogs.com/gif.latex?x_%7Bi%7D) in the training dataset:|
|   2-1 Choose its nearest vector ![Vnear](https://latex.codecogs.com/gif.latex?v_%7Bnearest%7D) from the *codebook*.|
|       If ![xi](https://latex.codecogs.com/gif.latex?x_%7Bi%7D)  and  ![Vnear](https://latex.codecogs.com/gif.latex?v_%7Bnearest%7D)  belong to the same class, then move ![Vnear](https://latex.codecogs.com/gif.latex?v_%7Bnearest%7D) closer to  ![xi](https://latex.codecogs.com/gif.latex?x_%7Bi%7D) using the following expression:|
...
|       Else, move ![Vnear](https://latex.codecogs.com/gif.latex?v_%7Bnearest%7D) away from  ![xi](https://latex.codecogs.com/gif.latex?x_%7Bi%7D) using the following expression:|
